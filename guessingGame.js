...
function checkGuess(){
	if (count > 1) {
		if (isNaN(playersGuess) === true || playersGuess % 1 !== 0 || playersGuess > 100 || playersGuess < 1) {
					...
					$('body').css('background', 'url(celebrate.gif)');
					$('.main').css('background-color', 'rgb(248,248,255)');
		...
		$('body').css('background', 'url(loser.gif)');
